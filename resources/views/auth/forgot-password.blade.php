...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Recover Password | meroblog - Admin & Dashboard  </title>
                    ...
                    <div class="card-body">
                        ...
                        <div class="p-3">
                            <form class="form-horizontal mt-3" method="POST" action="{{ route('password.email') }}">
                                ...
                                Enter Your <strong>E-mail</strong> Forgot your password? No problem. Just let us know your email address and we will email you a password reset link that will allow you to choose a new one.
