        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="index.html" class="logo logo-light">
                    <span class="logo-lg">
                        <img src="{{asset('backend/assets/images/logo.png')}}" alt="logo-lg-light" height="90">
                    </span>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block user-dropdown">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    <img class="rounded-circle header-profile-user" src="{{(!empty($adminData->profile_image)) ? url('upload/user_images/' . $adminData->profile_image) : url('upload/user_images/no_image.jpg')}}"
                        alt="Header Avatar">
